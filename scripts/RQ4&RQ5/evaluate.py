...
S_pass_sum_java = {'BatFix':0, 'LLM':0, 'RulER':0}
S_total_sum_java = {'BatFix':0, 'LLM':0, 'RulER':0}
S_pass_python = {'BatFix':[], 'LLM':[], 'RulER':[]}
S_pass_sum_python = {'BatFix':0, 'LLM':0, 'RulER':0}
S_total_sum_python = {'BatFix':0, 'LLM':0, 'RulER':0}
...
LLM_ave_r = 0
for method in methods:
    print(f'{method} average S_pass for Java: {round(S_pass_sum_java[method] / S_total_sum_java[method], 3)}')
    print(f'{method} average S_pass for Python: {round(S_pass_sum_python[method] / S_total_sum_python[method], 3)}')
    print(f'{method} average S_pass for Java and Python: {round((S_pass_sum_java[method]+S_pass_sum_python[method]) / (S_total_sum_java[method]+S_total_sum_python[method]), 3)}')
    if method == 'BatFix':
        BatFix_ave_r = round((S_pass_sum_java[method]+S_pass_sum_python[method]) / (S_total_sum_java[method]+S_total_sum_python[method]), 3)
        BatFix_py_r = round(S_pass_sum_python[method] / S_total_sum_python[method], 3)
    if method == 'RulER':
        RulER_ave_r = round((S_pass_sum_java[method]+S_pass_sum_python[method]) / (S_total_sum_java[method]+S_total_sum_python[method]), 3)
        RulER_py_r = round(S_pass_sum_python[method] / S_total_sum_python[method], 3)
    if method == 'LLM':
        LLM_ave_r = round((S_pass_sum_java[method]+S_pass_sum_python[method]) / (S_total_sum_java[method]+S_total_sum_python[method]), 3)

print(f'\nRulER than BatFix in average S_pass: {round((RulER_ave_r-BatFix_ave_r)/BatFix_ave_r, 2)}')
print(f'RulER than LLM in Python S_pass: {round((RulER_py_r-BatFix_py_r)/BatFix_py_r, 2)}')
print(f'RulER than LLM in average S_pass: {round((RulER_ave_r-LLM_ave_r)/LLM_ave_r, 2)}')
