            ...
            for file in files:
                if file.split('.')[0] == '0':
                    ...
                    prompt = f"{source_lang} Code:\n\n" + "".join(
                        code_lines) + f'\n\nTranslate the above {source_lang} code to {target_lang}.\n\nRequirements: Do not translate, modify, or replace the statement containing print("RulEROUTPUT:", ...). In the translated code, keep that statement as print("RulEROUTPUT:", ...).".\n{target_lang} Code:\n\n'
