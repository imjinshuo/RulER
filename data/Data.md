...
**Due to the large file size, please download `DATABASE.zip` from https://drive.google.com/file/d/1SSNidiFrTgq-7GyNxFkNiFg6Brp8eTE9/view?usp=sharing and unzip it to **`/data/DATABASE`**.**

**Manual evaluation resulsts for checking whether the datasets for rule mining and evaluation contain similar programs that solve identical problems can be downloaded in [`Data_Leak_Annotate.zip`](https://drive.google.com/file/d/1P3-HOZXlXCssnDyNyP9UlqnidbWR1OPK/view?usp=sharing).**
...
https://drive.google.com/file/d/1M8rcS8feLOWqGeFX-LCtGogeH-GmQryR/view?usp=sharing