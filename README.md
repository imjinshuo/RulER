...
- **Unzip the DATABASE.zip in **`/data`**.**

## Dataset

**The code translation rules generated by RulER and datasets needed for the experiment are stored in the [`/data/DATABASE.zip`](data/DATASET). Detailed information illustrating the structure and contents of our released dataset is provided in [`/data/Data.md`](/data/Data.md).**

Structure of [**`/data/DATABASE.zip`**](DATABASE.zip):
```
/data/DATABASE.zip
┝━━ DATA/
...
+ ***Note:** We do not recommend reproducing this module due to high time costs; execution results are already provided in [`/data/DATABASE.zip`](data/DATASET).*
